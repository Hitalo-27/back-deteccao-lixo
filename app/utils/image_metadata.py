...
IMAGE_DIR = "app/images"  # ajuste conforme o seu projeto
...
def extract_image_metadata(filename: str, base_dir: str = IMAGE_DIR):
    """
    Extrai metadados EXIF, coordenadas GPS e endereço (via geopy) da imagem.
    Retorna um dicionário com essas informações.
    """
    image_path = os.path.join(base_dir, filename)
    if not os.path.exists(image_path):
        raise FileNotFoundError(f"Arquivo '{filename}' não encontrado em {base_dir}")
